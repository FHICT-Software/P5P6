...
public class Persoon implements Serializable {
     ...
     *
     */
    Persoon(int persNr, String[] vnamen, String anaam, String tvoegsel, Calendar gebdat, String gebplaats, Geslacht g, Gezin ouderlijkGezin) {
        this.nr = persNr;
        this.voornamen = toPascalCase(vnamen);
        this.achternaam = toPascalCase(anaam);
        this.tussenvoegsel = tvoegsel.toLowerCase();
        this.gebDat = gebdat;
        this.gebPlaats = toPascalCase(gebplaats);
        this.geslacht = g;
        this.ouderlijkGezin = ouderlijkGezin;
        this.alsOuderBetrokkenIn = new ArrayList<>();
        this.observableAlsOuderBetrokkenIn = observableList(alsOuderBetrokkenIn);
    }
    ...
    public void setAlsOuderBetrokkenIn(Gezin g) {
